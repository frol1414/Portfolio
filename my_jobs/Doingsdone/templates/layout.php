            ...
            <div class="main-header__side">
                ...
                <div class="main-header__side-item user-menu">
                    ...
                    <div class="user-menu__data">
                        <p><?= filter_info($_SESSION['user']['name']); ?></p>
                ...
                <nav class="main-navigation">
                    <ul class="main-navigation__list">
                        ...
                        <li class="main-navigation__list-item">
                            <a class="main-navigation__list-item-link" href="index.php?projects_id=<?= $value['projects_id']; ?>"><?=filter_info($value['projects_name']);?></a>
                            <span class="main-navigation__list-item-count"><?=count_tasks($task_list, $value['projects_id']);?></span>
                        </li>
                    	<?php endforeach;?>
                    </ul>
                </nav>
